...
export const magesticEvolusSiteConfig = {
  name: "Magestic Evolus",
  about:
  ...
  navbar: {
    ...
    cta: {
      ...
      description:
        "Download the brochure to learn more about Magestic Evolus",
    },
  },
  ...
  hero: {
    ...
    welcome: {
      ...
      title: "Welcome to Magestic Evolus",
...
`,
  ...
  siteAndFloorPlan: {
    ...
    masterPlan: {
      ...
      cta: {
        ...
        description: "Explore the layout of Magestic Evolus",
      },
    },
    floorPlans: {
  ...
  amenities: {
    ...
    cta: {
      ...
      description: "Download the amenities of Magestic Evolus",
    },
    amenities: [
      {
        title: "Mini Theater",
  ...
  gallery: {
    ...
    cta: {
      ...
      description: "Download the gallery of Magestic Evolus",
    },
    images: [
      {
        title: "",
  ...
  virtualTour: {
    ...
    description:
      "Experience Magestic Evolus from the comfort of your home",
    cta: {
  ...
  legal: {
    rera: {
      ...
      description:
        "According to the RERA Act 2016 of the Government of India, all projects of the Magestic Evolus, are listed on the Maharashtra Government's RERA website under registered projects.",
      details: [
        {
          title: "Magestic Evolus",
    ...
    legalInfo: [
      ...
      },
      {
        title: "Site Address",
        description:
          "Site Address: Magestic Evolus: Palaspe Phata, Panvel, Navi Mumbai, Maharashtra 410221",
      },
      {
        title: "Contact Us",
        description:
  ...
  seo: {
    title:
      "Magestic Evolus 1, 2, 3 BHK & Jodi in Navi Mumbai | Price, Floor Plans, Amenities | Request Brochure",
    description:
      "Experience luxury living at Magestic Evolus,Navi Mumbai. 2 & 3 BHK apartments with world-class amenities.",
    keywords: [
      "luxury apartments",
      "Magestic Evolus",
      "1 bhk",
  ...
  termsAndConditions: {
    seo: {
      title: "Magestic Evolus | Terms & Conditions",
      description:
  ...
  privacyPolicy: {
    seo: {
      title: "Magestic Evolus | Privacy Policy",
  ...
  cookiesPolicy: {
    seo: {
      title: "Magestic Evolus | Cookies Policy",
      description:
  ...
  thankYou: {
    seo: {
      title: "Magestic Evolus | Thank You",
      description: "Thank you for your interest in Magestic Evolus",
    },
  },
  ...
  formSubmission: {
    ...
    email: {
      ...
      template: {
        subject: "New Enquiry from Magestic Evolus",
      },
    },
  },
};

export type MagesticEvolusSiteConfig = typeof magesticEvolusSiteConfig;
